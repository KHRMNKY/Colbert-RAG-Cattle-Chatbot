...
export const MobileSidebar: React.FC<MobileSidebarProps> = ({ 
  ...
  return (
    <>
      {/* Mobil Menü Butonu - İyileştirilmiş */}
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="md:hidden fixed top-4 left-4 z-50 bg-gradient-to-r from-green-700 to-green-800 hover:from-green-800 hover:to-green-900 text-white p-3 rounded-2xl transition-all duration-200 shadow-xl hover:shadow-2xl border border-green-600/50 backdrop-blur-sm"
      >
        <svg 
      ...
      {/* Sidebar */}
      <div className={`md:hidden fixed top-0 left-0 h-full w-80 bg-gradient-to-b from-green-900 to-green-800 z-50 transform transition-transform duration-300 ease-in-out shadow-2xl ${
        ...
        <div className="h-full p-4 flex flex-col">
          ...
          <div className="mb-6 mt-14">
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white rounded-2xl p-4 transition-all duration-300 shadow-xl hover:shadow-2xl active:scale-[0.98] flex items-center justify-center space-x-3 group border border-emerald-400/20"
            >
